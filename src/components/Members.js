...
class Members extends React.Component {
	render() {
		...
		const image_url_string = new URL('https://drive.google.com/open?id=1oN1EbU9Y1-2Xpsjwv0ieFONqDXyTMoVp'),
				...
				<div className="container-fluid">
					<div className="row">
						<div className="col-lg-12 text-center">
							<img src={`https://drive.google.com/uc?export=view&id=${image_id}`} height="200px" className="rounded-circle" alt={details.name} />
