...
import { faCoffee, faHeart, faCode, faPhone, faEnvelope, faRss } from "@fortawesome/fontawesome-free-solid"

const Footer = () => (
	<section>
		<div className="row josefinSlab fa-icons">
			<div className="col-lg-12 text-center" style={{ paddingBottom: "40px" }}>
				<h2	className="section-heading ailerons" style={{ fontSize: "40px" }}>
					Let's Get In Touch!
				</h2>
			...
			<div className="col-lg-2 offset-lg-2 text-center">
				<FontAwesomeIcon icon={ faPhone } className="fa-3x" flip="horizontal"/>
		...
		<div className="row ailerons orange text-center" style={{ paddingTop: "100px" }}>
			<div style={{ borderRight: "3px solid", height: "40px" }} className="col-12">
			...
			<div className="col-12" style={{ paddingTop: "40px" }}>
				<p style={{ fontSize: "28px" }}>
					...
					<a id="credits" href="https://bit.do/sreetamdas" style={{ border: "2px solid" }}>
						Sreetam Das
					</a>
				</p>
			</div>
